...
internal class CreateOptionalUseCaseTest{

  private val logger: Logger = mock()
  private val saveOptionalPort: SaveOptionalPort = mock()
  private val getMenuByIdPort: GetMenuByIdPort = mock()
  private val createOptionalUseCase = CreateOptionalUseCase(logger, saveOptionalPort, getMenuByIdPort)

  @Test
  fun `Test Create Optional Use Case - verify if save port is being called`() {
  ...
  @Test
  fun `Test Create Optional Use Case - verify if an event is emitted`() {
    givenSomeCorrectSavePort()
  ...
  private fun whenUseCaseIsExecuted() =
    createOptionalUseCase.execute(optional)
